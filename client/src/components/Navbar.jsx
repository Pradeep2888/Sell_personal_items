        ...
        <header className="bg-white h-[90px] flex items-center box-border max-w-[1700px] mx-auto">
            <div className="flex justify-between items-center w-full px-4 lg:px-0">
                ...
                <div className="hidden lg:flex items-center gap-8 w-full">
                    <div className="logo"><img width={"auto"} height={"100%"} src={logo} /></div>
                    <nav className='ml-[45px]'>
                        <ul className='flex items-center '>
                            <li className='font-[lexend deca] text-primary font-medium text-base py-4 '><Link to={''}>Home</Link></li>
                            <li className='font-[lexend deca] text-primary font-medium text-base py-4 ml-[45px] '><Link to={'/memberships'}>Memberships</Link></li>
                            <li className='font-[lexend deca] text-primary font-medium text-base py-4 ml-[45px] '><Link to={'/donate'}>Donate</Link></li>
                ...
                <div className='block lg:hidden'>
                    <div className='account flex justify-center items-center gap-4'>
                        <Link to={'/login-register'} className='flex justify-center items-center relative overflow-hidden transition-all text-nowrap font-medium py-4 h-[50px] w-[50px] rounded-full border border-black'>
