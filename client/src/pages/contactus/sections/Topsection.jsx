...
import about_us_banner_1 from '../../../assets/contact-us-banner.jpg'

function TopSection() {
    return (
        <div className='relative w-full'>
            <div className='relative'>
                <div className='absolute w-full h-full bg-[#374b5c] opacity-[0.33] transition duration-[0.3s] ease-linear delay-0 z-10'></div>
                ...
                <div className='w-full absolute z-10 top-0 left-0'>
                    <div className='mx-auto h-full min-h-[290px] max-w-[1200px] relative'>
                        <div className='flex flex-col absolute bottom-0 gap-6 justify-end items-baseline'>
                            <div>
                                <h1 className='text-5xl text-[#FFB300] font-bold'>Contact <span className='text-white '>us</span></h1>
                            </div>
                            <ul className='flex relative bg-white px-8 py-4 rounded gap-4'>
                                ...
                                <li className='text-[#B18B8C] text-base font-medium'>Contact Us</li>
                            </ul>
                        </div>
                    </div>
                </div>
