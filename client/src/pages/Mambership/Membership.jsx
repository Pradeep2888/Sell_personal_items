...
function Membership() {
    ...
    const includedFeatures = data?.plans[0]?.features.map((itm) => itm.name) || [
        'Wide audience reach',
        'Verified Users',
        'Buyer-seller chat',
        'Premium Support',
                    ...
                    <div className="-mt-2 p-2 lg:mt-0 lg:w-full lg:max-w-md lg:flex-shrink-0">
                        <div className="rounded-2xl bg-gray-50 py-10 text-center ring-1 ring-inset ring-gray-900/5 lg:flex lg:flex-col lg:justify-center lg:py-16">
                            <div className="mx-auto max-w-xs px-8">
                                <p className="text-base font-semibold text-gray-600">Pricing That Fits</p>
                                <p className="mt-6 flex items-baseline justify-center gap-x-2">
                                    <span className="text-5xl font-bold tracking-tight text-primary">{`${data?.plans[0]?.currency}${data?.plans[0]?.price}`}</span>
