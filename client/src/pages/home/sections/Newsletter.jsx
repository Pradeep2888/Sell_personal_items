        ...
        <div className='w-full relative py-5 bg-[#283641]'>
            <div className='lg:max-w-7xl mx-auto'>
                <div className='flex py-5 lg:py-10 flex-col sm:flex-row gap-4 lg:gap-0 justify-between items-center '>
                    <div className=''>
                        <h2 className='text-white text-xl lg:text-4xl max-w-[600px] font-bold'>{text ? text : "Subscribe To Our Newsletter"}</h2>
                    </div>
                    <div className='grow px-4 lg:px-0 lg:ml-20'>
                        <div className='flex justify-center lg:justify-between items-center gap-4 bg-white lg:p-5 p-2 rounded-md' >
                            <div className=' relative grow'>
                                <input className='border border-[#D5E3EE] rounded-md py-4 lg:py-5 px-16 focus:outline-none placeholder:text-[#374b5c] w-full lg:text-base font-medium' type="email" placeholder="Email" />
