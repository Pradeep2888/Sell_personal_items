            ...
            <table className="w-full text-sm text-left rtl:text-right text-gray-500">
              <thead className="text-xs text-primary font-medium uppercase bg-gray-100">
                <tr>
                  ...
                  <th scope="col w-0" className="px-6 py-3">
              ...
              <tbody>
                ...
                {myOrders?.map((item, i) =>
                  <tr key={i} className="bg-white hover:bg-gray-5">
                    ...
                    <td className="px-6 py-4 w-fit font-semibold text-primary text-nowrap">
                      {item.product.category.name}
                    </td>
                    <td className="px-6 py-4 w-0 font-semibold text-primary">
